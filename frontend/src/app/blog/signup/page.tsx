      ...
      <div className="relative z-10 min-h-screen flex items-center justify-center pt-40 px-4 py-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-md w-full">
          <div className="text-center mb-8">
            <ShinyText text="Crear Cuenta" className="text-4xl font-bold text-white mb-4" />
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 mb-6">
              ...
              <div>
                <Input
                  ...
                  {...register('nombre')}
                />
                {errors.nombre?.message && <p className="text-red-500 text-sm mt-1">{errors.nombre.message}</p>}
              </div>
              <div>
                <Input
                  type="text"
                  ...
                  {...register('apellidos')}
                />
                {errors.apellidos?.message && <p className="text-red-500 text-sm mt-1">{errors.apellidos.message}</p>}
              </div>
